...
class PetrieModel:
    ...
    If user iterations not defined, the model would run for 1000 iterations by default'''
    ...
    # def run_model(self, n_iterations=100):
    #     male = female = 0
    #     for count in range(n_iterations):
    #         self.step()
    #
    #     for index, value in enumerate(self.population):
    #         if value[1] == "Male" and value[3] >= 1:
    #             male += value[3]
    #         if value[1] == "Female" and value[3] >= 1:
    #             female += value[3]
    #     # print('number of male:{}'.format(number_of_male))
    #     # mean number of sexist remarks per male
    #     mmale = (male / self.number_of_male)
    #     # print('number of female:{}'.format(number_of_female))
    #     # mean number of sexist remarks per female
    #     mfemale = (female / self.number_of_female)
    #
    #     # Print the summary
    #     print("Mean sexist remarks received by male:{}".format(mmale))
    #     print("Mean sexist remarks received by female:{}".format(mfemale))
    #     print("Petrie Multiplier:{}".format(mfemale / mmale))
    '''
    provides summary of the statistics related to Petrier Model
    '''
